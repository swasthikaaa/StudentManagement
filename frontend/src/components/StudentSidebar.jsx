...
import { LayoutDashboard, BookOpen, Clock, User, LogOut, DollarSign, X } from 'lucide-react';
...
const StudentSidebar = ({ onClose }) => {
    ...
    return (
        <div className="h-screen w-64 bg-primary-dark text-white flex flex-col shadow-xl">
            <div className="p-6 border-b border-slate-700/50 flex items-center justify-between">
                ...
                <button
                    onClick={onClose}
                    className="md:hidden p-1 hover:bg-white/10 rounded-lg text-slate-400"
                >
                    <X size={20} />
                </button>
            </div>
